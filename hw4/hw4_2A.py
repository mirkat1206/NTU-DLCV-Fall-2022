...
# optimizer = torch.optim.Adam(mynn.get_params_to_update(), lr=0.2, betas=(0.9, 0.999))
...
for epoch in range(200):
    ...
    if accuracy > best_accuracy:
        ...
        torch.save(mynn.backbone.state_dict(), './checkpoint/hw4_2A_backbone.pt')
        torch.save(mynn.classifier.state_dict(), './checkpoint/hw4_2A_classifier.pt')
